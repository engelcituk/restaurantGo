             ...
             <form action="">
              ...
              ?>
                <div class="input-group">
                  ...
                  <select class="form-control" name="lstSelectHotel" id="lstSelectHotel" required>
                      <option value=""><?php echo $nombreHotelSelect ?></option>
                      <?php 
                        $listaHoteles= new ControladorSeatings();
              ...
              <div class="col-md-3 col-xs-12" >
                <div class="input-group">
                  ...
                  <select class="form-control" name="lstSeatingRestaurante" id="lstSeatingRestaurante" required>
                      <option value=""><?php echo $nombreRestauranteSelect ?></option>
        ...
        <div class="register-box-body">              
          <form method="post">                                
            ...
            <div class="row" id="elegirHorarioSeating">
              <div class="col-md-6 col-xs-12">
                <span><strong>Lista Horarios</strong></span>        
              ...
              <div class="col-md-6 col-xs-12">
                <span><strong>Hora Seleccionada</strong></span>        
                <div class="input-group">
                  <div class="input-group-addon"><i class="fas fa-clock"></i></div>
                  <input type="text" id="horaElegidaCampo" name="horaElegidaCampo" class="form-control" readonly required>                
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6 col-xs-12">
                <span><strong>Cantida de Pax</strong></span>        

                ...
                <tbody>
                  ...
                  foreach ($respuesta as $fila => $elemento) {
                    ...
                    <tr>
                        ...
                        <td><button class="' . $termica . '">' . $siNo . '</button></td>';
            ...
            <form method="post">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                  ...
                  <!-- <div class="input-group"> -->
                  <div class="radio">
                    <label><input type="radio" name="termica" value="1" checked>Sí</label>
                    <label><input type="radio" name="termica" value="0">No</label>
                  </div>
                  <!-- </div> -->
                </div>
        ...
        <div class="modal-body">
          ...
          <div class="register-box-body">
            <form method="post">
              ...
              <div id="ipValidoMensajeEditar"></div>
              <div class="row">
                <div class="col-md-6 col-xs-12">

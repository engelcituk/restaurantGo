    ...
    <section class="content">
      ...
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title"> Tickets: disponibles en varios idiomas</h3>
        ...
        <div class="box-body">
          ...
          <div class="row">
           ...
           <!-- <?php 
              // $verListaTicket2 = new ControladorTicket();
              // $verListaTicket2->ctrTraerListaDeTicket2();
           ?> -->
            ...
            <div class="row" >
              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="encabezado" id="encabezado" value="SANDOS HOTELS & RESORTS." minlength="20" required>                
                </div>
              </div>            

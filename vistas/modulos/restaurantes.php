              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <?php 
                    ...
                    $listaHoteles->ctrMostrarListaHoteles();
                  ?>
                </ul>
              </div>
            </div>            
                  ...
                  foreach ($respuesta as $fila => $elemento) {
                    ...
                    <tr id="'.$elemento["id"].'">
                        ...
                        echo '<td>
                              ...
                              <button class="btn btn-danger eliminarRestaurante" idRstrnt="'.$elemento["id"].'"><i class="fa fa-trash "></i></button>               
                        </td>
                        <td></td>
                    </tr>';
                    $contador=$contador +1;
...
<!-- AQUI VA LA INSTANCIA PARA LLAMAR AL CONTROLADOR DEL BORRADO DEL RESTAURANTE -->
 <?php 
    $borrarHotel = new ControladorRestaurantes();
    $borrarHotel -> ctrBorrarRestaurante();

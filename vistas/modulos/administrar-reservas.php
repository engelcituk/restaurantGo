                          ...
                          <tr id="'.$elemento["id"].'">
                            ...
                            if ($_SESSION["ACTIVAR RESERVAS"]==1){
                              if ($elemento["estado"]!=0) {
                                echo '<td><button class="btn btn-success btn-xs btnActivarRSV" idRsv="'.$elemento["id"].'" estadoRsv="0">Activado</button></td>';
                                  }else{
                                    echo'<td><button class="btn btn-danger btn-xs btnActivarRSV" idRsv="'.$elemento["id"].'" estadoRsv="1">Desactivado</button></td>';
                                  }
                             }
                            if ($_SESSION["REIMPRIMIR TICKET"]==1){
                              echo '
                      ...
                      <div class="col-md-6 col-xs-6">
                         <?php
                            ...
                            foreach ($respuestaModal as $fila => $elemento) {
                              echo '                              
                              <option idHotelEditar="'.$valorCampo.'" idRestauranteEditar="'.$elemento["id"].'" value="'.$elemento["nombre"].'">'.$elemento["nombre"].'</option>                            
                                    ';
                            }
                            echo '</select>'; 
                           ?> 
